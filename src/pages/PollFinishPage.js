...
export default function PollFinishPage({
  handleChangeState,
  pollName
}){
    return (
        <ThemeProvider theme={themeLight}>
          <CssBaseline />
            ...
            <Container sx={{ py: 8, }} maxWidth="md">
                <div className='optima_text' align='center'>A poll named </div>
                <div className='optima_text red_text' align='center'>{pollName}</div>
