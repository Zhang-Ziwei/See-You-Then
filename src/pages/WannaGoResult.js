    ...
    <ThemeProvider theme={themeLight}>
      ...
      <main>
        ...
        <Container
          ...
          style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', background: 'linear-gradient(to right,#F695FF,#F695FF,#F695FF,#CCCCCC, #CCCCCC)'}}>

          <div className='rwdfaceimg' style={{ backgroundImage: `url(${FaceLove})` }} alt='Done' />
          <div className='wannagoText'> I Wanna Go!  6人</div>
          <div className='rwdfaceimg' style={{ backgroundImage: `url(${FaceLove})` }} alt='Done' />
        </Container>
        <br/><br/>
        <Container
          ...
          style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', background: 'linear-gradient(to right,#F695FF,#CCCCCC,#CCCCCC,#CCCCCC, #CCCCCC)'}}>

          <div className='rwdfaceimg' style={{ backgroundImage: `url(${FaceThink})` }} alt='Done' />
          <div className='wannagoText'> Maybe I will?  2人</div>
          <div className='rwdfaceimg' style={{ backgroundImage: `url(${FaceThink})` }} alt='Done' />
        </Container>
        <br/><br/>
        <Container
          ...
          <div className='wannagoText'> Sorry, I can't  2人</div>
          <div className='rwdfaceimg' style={{ backgroundImage: `url(${FaceCry})` }} alt='Done' />
        </Container>
                <Stack
                  sx={{ pt: 4 }}
